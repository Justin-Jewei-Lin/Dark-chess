...
# Project:  project.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile project.pro 'QT += widgets'
#############################################################################
...
DISTDIR = /home/User/project/.tmp/project1.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: project.pro /usr/lib/qt5/mkspecs/cygwin-g++/qmake.conf /usr/lib/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt5/mkspecs/features/lex.prf \
		project.pro
	$(QMAKE) -o Makefile project.pro 'QT += widgets'
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Chess.h MainWindow.h $(DISTDIR)/
	$(COPY_FILE) --parents Chess.cpp main.cpp MainWindow.cpp $(DISTDIR)/
...
moc_MainWindow.cpp: Chess.h \
		MainWindow.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt5/mkspecs/cygwin-g++ -I/home/User/project -I/home/User/project -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/lib/gcc/x86_64-pc-cygwin/9.3.0/include/c++ -I/usr/lib/gcc/x86_64-pc-cygwin/9.3.0/include/c++/x86_64-pc-cygwin -I/usr/lib/gcc/x86_64-pc-cygwin/9.3.0/include/c++/backward -I/usr/lib/gcc/x86_64-pc-cygwin/9.3.0/include -I/usr/include -I/usr/include/w32api MainWindow.h -o moc_MainWindow.cpp
